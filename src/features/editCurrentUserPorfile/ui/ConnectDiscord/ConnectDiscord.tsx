...
export const ConnectDiscord = memo((props: ConnectDiscordProps) => {
  ...
  const handleRedirectToOAuth = () => {
    const url = IS_DEV
      ...
      // eslint-disable-next-line max-len
      : 'https://discord.com/oauth2/authorize?client_id=1052413956788080641&response_type=token&redirect_uri=https%3A%2F%2Froyalarena.ru%2Fprofile%2Fedit%2F%3F&scope=identify';

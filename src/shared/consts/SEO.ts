...
export const DEFAULT_KEYWORDS = [
  ...
  'сессии в танках', 'история сессий tanks blitz', 'турниры tanks blitz', 'турниры в танках',
];
export const DEFAULT_DESCRIPTION = 'Неофициальный сервис статистики и отслеживания игровых сессий для игры Tanks Blitz';

export const DEFAULT_IMAGE = 'https://i.ibb.co/Mp8t70p/Royal-Arena-OG.jpg';
